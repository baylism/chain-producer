...
@Component
public class ReactiveKafkaProducerTyped {

    @Value("${KAFKA_BOOTSTRAP_SERVERS}")
    private String bootstrapServers;

    private static final Logger logger = LoggerFactory.getLogger(ReactiveKafkaProducerTyped.class);

    private SenderOptions<Blockchain, String> senderOptions;
    private KafkaSender<Blockchain, String> sender;

    public ReactiveKafkaProducerTyped() {
    }
    ...
    public void buildSender() {
        ...
        producerProps.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, BlockchainSerializer.class);
    ...
    public Flux<?> send(Flux<String> source, String topic, Blockchain key) {
        ...
        return sender
                ...
                .doOnNext(record -> {
                    Blockchain correlationMetadata = record.correlationMetadata();
    ...
    public Flux<?> send(Mono<String> source, String topic, Blockchain key) {
